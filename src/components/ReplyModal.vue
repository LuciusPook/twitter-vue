<template>
  <div class="reply__modal">
    <div class="reply__modal--nav">
      <span class="cancel-btn" @click="handleCancelReplyModal">&#215;</span>
    </div>
    <div class="replyModal__tweet">
      ...
      <div class="replyModal__tweet--content">
        <div class="replyModal__title">
          ...
          <a href=""
            ><p class="replyModal__title--account">
              @{{ tweet.User.account }}
            </p></a
          >
          <span class="replyModal__title--time"
        ...
        <div class="replyModal__tweet--account">
    ...
    <div class="replyModal__input--container">
      <div class="replyModal__input--avatarContainer">
        <img
          ...
          alt=""
          class="replyModal__input--avatar"
        />
      </div>
    ...
    <button class="reply__btn" @click="submitReply(tweetId)">回覆</button>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    async submitReply(tweetId) {
      ...
      try {
        const response = await tweetAPI.reply.addReply({
          tweetId,
